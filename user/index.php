            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info-cs res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                            <h3 class="box-title">Total Data-Digital</h3>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info-cs res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                            <h3 class="box-title">Kategori Data-Digital</h3>
                            <ul class="list-inline two-part-sp">
                                <li>
                ...
                <div class="product-sales-chart">
                    ...
                    <center>
                        ...
                        <h4>Sistem Informasi Data-Digital</h4>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                ...
                <div class="single-cards-item">
                    ...
                    <div class="single-product-text">
                        ...
                        <h5>user</h5>
                        <p class="ctn-cards">Pengelolaan data jadi lebih mudah dengan sistem informasi data-digital.</p>
                    </div>
                </div>
