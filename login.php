...
<head>
    ...
    <title>Login Admin | Sistem Informasi Data-Digital</title>
    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. All rights reserved. Sistem Informasi Data-Digital BPAD NTT</p>
            </div>
        </div>   
    </div>
